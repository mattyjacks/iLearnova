        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="flex space-x-3 pt-2">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="bg-white/10 hover:bg-white/20 p-2 rounded-full transition-all duration-300 transform hover:scale-110"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/#testimonials" className="text-gray-300 hover:text-yellow-400 transition-colors">Testimonials</Link></li>
              <li><Link href="/#about" className="text-gray-300 hover:text-yellow-400 transition-colors">About</Link></li>
              <li><Link href="/contact" className="text-gray-300 hover:text-yellow-400 transition-colors">Support</Link></li>
            </ul>
          </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-2 text-gray-300">
                ...
                <div className="text-sm space-y-1">
                  <a href="mailto:dimatechitconsultancy@gmail.com" className="hover:text-yellow-400 transition-colors block">
                    dimatechitconsultancy@gmail.com
                  </a>
                  <a href="mailto:ilearnova@gmail.com" className="hover:text-yellow-400 transition-colors block">
                    ilearnova@gmail.com
                  </a>
                </div>
              </li>
              <li className="flex items-start space-x-2 text-gray-300">
                ...
                <div className="text-sm space-y-1">
                  <a href="tel:+2349050119078" className="hover:text-yellow-400 transition-colors block">
                    +234 905 011 9078
                  </a>
                  <a href="tel:+2347061500944" className="hover:text-yellow-400 transition-colors block">
                    +234 706 150 0944
                  </a>
                </div>
              </li>
              <li className="flex items-start space-x-2 text-gray-300">
                ...
                <span className="text-sm">162, AGBODU QUARTERS, ITELE IJEBU, Nigeria</span>
              </li>
            </ul>
          </div>
        </div>
